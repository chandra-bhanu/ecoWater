...
import 'package:eco_water_app/app/app_strings.dart';
...
class ActivityWidget extends StatelessWidget {
  const ActivityWidget({Key? key, required this.activityType, required this.activityQuality})
      : super(key: key);
  ...
  String _titleForActivityType(ActivityType activityType) {
    switch (activityType) {
      case ActivityType.walking:
        return AppStrings.activityWalking;
      case ActivityType.running:
        return AppStrings.activityRunning;
      case ActivityType.biking:
        return AppStrings.activityBiking;
    }
